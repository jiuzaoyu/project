...
public class DateUtil {
	...
	public static Date getShortDate(Date date) {    
	    ...
	    Date shortDate = StringToDate(dateString, "yyyy-MM-dd");  
	    return shortDate;  
	} 
	...
	* @return
	...
	public static boolean isMixedOrEqual(Date firstStartTime,Date firstEndTime,Date secondStartTime,Date secondEndTime){
		if((firstStartTime.getTime()<=secondEndTime.getTime() && firstEndTime.getTime()>=secondStartTime.getTime()) || (secondStartTime.getTime()<=firstEndTime.getTime() && secondEndTime.getTime()>=firstStartTime.getTime())){
			return true;
		}
		return false;
	}
	...
	* @return
	...
	/**
	 * 计算两个月份相差天数，开始时间和结束时间所占的月份也算在内
	 * @param begin
	 * @param end
	 * @return
	 * @throws ParseException
	 */
	public static int getMonthSpace(Date begin, Date end)throws ParseException {
        int result = 0;
        Date tmp = begin;
        ...
        result = (end.getYear()-begin.getYear())*12 + (end.getMonth()-begin.getMonth()) + 1;
